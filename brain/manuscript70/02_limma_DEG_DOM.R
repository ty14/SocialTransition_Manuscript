...
saveRDS(v.dl, glue("manuscript/brain/manuscript70/results/limma_vdl_{my_region}"))
...
saveRDS(q.dl,glue("manuscript/brain/manuscript70/results/results_RNAseqRDS/limma_eFDR_{my_region}_cutoff5_R{R}_contrast.RDS"))

q.dl <- readRDS(glue("manuscript/brain/manuscript70/results/results_RNAseqRDS/limma_eFDR_{my_region}_cutoff5_R{R}_contrast.RDS"))


png(filename = glue("manuscript/brain/manuscript70/results/img/eFDR_hist_{my_region}R{R}_contrast.png"),
...
saveRDS(limma_list,glue("manuscript/brain/manuscript70/results/results_RNAseqRDS/limma_{my_region}.RDS"))
